/*
 * The section below build on the configuration files in networkdomain.tf and includes resource
...
#  5.  If nothing is changes, the resource definition will create (2) network VLANs with the
